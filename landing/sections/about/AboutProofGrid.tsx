...
const proofItems = [
  { icon: <IconUsers />, value: '5000+', label: '成功治疗案例' },
  { icon: <IconTrendingUp />, value: '92%', label: '用户满意度' },
  { icon: <IconShield />, value: '二类医疗', label: '器械认证' },
  { icon: <IconAward />, value: '3+30', label: '专利+软著' },
];
