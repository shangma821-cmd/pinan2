...
const steps: Step[] = [
  {
    ...
    label: '健康评估',
    title: '基础评估',
    body: '通过智能问询、设备采集与数据分析，建立个人健康状态档案',
    highlight: '形成个性化服务建议',
  },
  {
    id: 'heal',
    ...
    label: '节律调理',
    title: '方案生成',
    body: '根据评估结果，制定个性化频谱节律调理与生活方式建议',
    highlight: '阶段化服务跟进',
  },
  {
    id: 'track',
    ...
    label: '持续记录',
    title: '数据追踪',
    body: '智能手环记录日常健康数据，云端沉淀服务档案与趋势变化',
    highlight: '随时查看状态趋势',
  },
  {
    id: 'reward',
    ...
    <section data-testid="home-process" className="landing-process-section">
      ...
      <div className="landing-process-inner">
        ...
        >
          ...
          <p className="landing-process-subtitle">从状态评估到持续管理，四大环节形成完整服务链条</p>
        </div>
        ...
        <div className="landing-process-stat-pill-wrap">
          <div className="landing-process-stat-pill landing-apple-card">
            <div className="landing-process-stat">
              ...
              <div className="landing-process-stat-label">快速评估</div>
            </div>
            <div className="landing-process-stat-divider" />
            <div className="landing-process-stat">
              <div className="landing-process-stat-value">7天</div>
              <div className="landing-process-stat-label">跟进周期</div>
            </div>
            <div className="landing-process-stat-divider" />
            <div className="landing-process-stat">
